...
public class EmpresaCliente {
    ...
    private ArrayList<Factura> Listafacturadecompras = new ArrayList<>();
    private ArrayList<Factura> Listafacturadeventas = new ArrayList<>();

    private GestoraEntidades gestoraEntidades = new GestoraEntidades();

    public GestoraEntidades getGestoraEntidades() {
        return gestoraEntidades;
    }

    // ---------------------------------------------------
    //  Constructor para CREAR una empresa nueva
    // ---------------------------------------------------
    public EmpresaCliente(String aliasEmpresa, String razonSocial, String nombredefantasia, String cuit,
                          int condiciondeiva, String IB, String actividad, String direccion,
        ...
        // Listas ya inicializadas arriba, no hace falta hacerlo otra vez
        if (condiciondeiva != 1 && condiciondeiva != 2 && condiciondeiva != 3) {
            throw new TipodeEmpresa("El número ingresado debe ser 1, 2 o 3");
        }
    }

    // ---------------------------------------------------
    //  Constructor para CARGAR desde archivo o JSON
    // ---------------------------------------------------
    public EmpresaCliente(String aliasEmpresa, String razonSocial, String nombredefantasia, String cuit,
                          TipoCondiciondeIva condiciondeiva, String IB, String actividad, String direccion,
                          String localidad, String provincia, String telefono,
                          String correoElectronico, String paginaweb,
                          ArrayList<Factura> listafacturadecompras, ArrayList<Factura> listafacturadeventas) {
        ...
        // ✅ Si vienen null desde JSON, las reemplaza
        this.Listafacturadecompras = (listafacturadecompras != null) ? listafacturadecompras : new ArrayList<>();
        this.Listafacturadeventas = (listafacturadeventas != null) ? listafacturadeventas : new ArrayList<>();
    }
